...
// TODO implement if we want to set like a ready state before each match
//    const matchStartButton = document.getElementById("lobby-match-start-button");
//    if (matchStartButton) {
//        matchStartButton.onclick = function (event) {
//            event.preventDefault;
...
//    }
    ...
    chatSocket.onmessage = function (event) {
        ...
        // TODO should prob handle this at some point
          return;
        }
    }
    ...
    // TODO handle this via classes instead
